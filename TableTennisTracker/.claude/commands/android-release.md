...
4. Update both values in `androidApp/build.gradle.kts` and commit the version changes
...
8. Add git tag in format `android-{version-name}` and push all the commit and tag to origin
