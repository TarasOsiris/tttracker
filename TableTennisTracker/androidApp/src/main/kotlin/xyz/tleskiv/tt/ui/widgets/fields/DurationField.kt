...
fun DurationField(durationMinutes: Int, onDurationChange: (Int) -> Unit) {
	Column {
		Row(
			...
			FieldLabel(R.string.label_duration)
			Text(
				text = stringResource(R.string.suffix_minutes_value, durationMinutes),
		...
		Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.SpaceBetween) {
			Text(
				text = stringResource(R.string.suffix_minutes_value, MinDurationMinutes),
				style = MaterialTheme.typography.bodySmall,
				color = MaterialTheme.colorScheme.onSurfaceVariant
			)
			Text(
				text = stringResource(R.string.suffix_minutes_value, MaxDurationMinutes),
				style = MaterialTheme.typography.bodySmall,
				color = MaterialTheme.colorScheme.onSurfaceVariant
			)
		}
