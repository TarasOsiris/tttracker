...
import xyz.tleskiv.tt.repo.impl.AnalyticsRepositoryImpl
...
val appModule = module {
	...
	single<AnalyticsRepository> {
		AnalyticsRepositoryImpl(get(), get(named(DispatcherQualifiers.IO)))
	}
}
...
fun initApp(platformModule: Module, configure: KoinAppDeclaration = {}) {
	...
	crashReporter.start(nativeInfoProvider.sentryDsn, userId)
