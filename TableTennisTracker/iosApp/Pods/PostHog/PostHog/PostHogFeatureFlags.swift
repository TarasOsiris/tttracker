...
private
    ...
    func preloadSesssionReplayFlag() {
        var
        sessionReplay:
        [String :Any] ?
    ...
    anonymousId: String,
                ...
                groups: groups)
        {
            ...
            self.dispatchQueue.async
            {
                ...
                let
                errorsWhileComputingFlags = data ? ["errorsWhileComputingFlags"] as ? Bool ?? false
                ...
                self.featureFlagsLock.withLock
                {
                    if errorsWhileComputingFlags{
                                ...
                                let newFeatureFlagsPayloads = cachedFeatureFlagsPayloads.merging(featureFlagPayloads) {
                                    _, new in
                                    new
                                }
