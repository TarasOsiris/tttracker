...
private
    var storage: PostHogStorage ?
                 ...
                 #endif
private
    var flagCallReported = Set<String>()
private
    var featureFlags: PostHogFeatureFlags ?
private
    var context: PostHogContext ?
private
    static var apiKeys = Set<String>()
private
    var capturedAppInstalled = false
private
    var appFromBackground = false
private
...
private
    ...
    ]
    {
        ...
        let
        propDistinctId = props["distinct_id"]
        as ? String
...
public
    ...
    : String) {
        capture(event,
                properties: nil, userProperties: nil, userPropertiesSetOnce: nil, groups: nil)
    }
...
public
    ...
    {
        capture(event,
                properties: properties, userProperties: nil, userPropertiesSetOnce: nil, groups: nil)
    }
...
public
    ...
    {
        capture(event,
                properties: properties, userProperties: userProperties, userPropertiesSetOnce: nil, groups: nil)
    }
...
public
    ...
    {
        capture(event,
                properties: properties, userProperties: userProperties, userPropertiesSetOnce: userPropertiesSetOnce, groups: nil)
    }
...
public
    ...
    properties: [String :Any] ? = nil
        ...
        props = [
                ...
                ].merging(sanitizeDicionary(properties) ? ? [:]) {
            prop, _
            in
            prop
        }
...
public
    ...
    : String) -> Any? {
        ...
        guard
        let
        featureFlags = featureFlags else {
            return nil
        }
...
private
    ...
    func captureAppInstallLifecycle() {
