...
protocol ScreenViewPublishing
: AnyObject {
/// Registers a callback for a view appeared event
func onScreenView(_ callback

: @
escaping ScreenViewHandler
) -> RegistrationToken
}
...
private
    ...
    onScreenView(_
    callback: @escaping
    ScreenViewHandler) -> RegistrationToken {
        let id = UUID()
...
private
    ...
    : @
    escaping ScreenViewHandler, screen: String
    ) {
