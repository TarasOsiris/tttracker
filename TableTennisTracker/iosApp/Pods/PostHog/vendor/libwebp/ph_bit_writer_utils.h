...
VP8BitWriterPos(const VP8BitWriter *const bw) {
...
VP8BitWriterBuf(const VP8BitWriter *const bw) {
    return bw->buf_;
}
...
VP8BitWriterSize(const VP8BitWriter *const bw) {
    return bw->pos_;
}
...
VP8LBitWriterNumBytes(const VP8LBitWriter *const bw) {
